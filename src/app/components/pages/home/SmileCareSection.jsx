      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16 xl:px-24">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-secondary leading-tight mb-2">
        ...
        <div className="relative">
          ...
          >
            {services.map((service) => (
              <SwiperSlide
                key={service.id}
                className="w-[280px]! sm:w-[300px]! bg-primary/20 text-secondary rounded-2xl overflow-hidden flex flex-col justify-between"
              >
                <div className="p-4">
