...
export default function AboutClinic() {
  return (
    <section className="relative bg-white py-14 sm:py-18 md:py-24 overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16 xl:px-24 flex flex-col lg:flex-row items-center gap-16 relative z-10">
        ...
        <div className="relative flex-1 flex justify-center items-center w-full">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative w-full max-w-[600px] sm:max-w-[650px] flex justify-center"
          >
            {/* Main Image */}
            <div className="rounded-3xl overflow-hidden shadow-2xl h-[380px] sm:h-[480px] md:h-[550px] lg:h-[600px] relative z-10 w-full">
              <Image
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute left-1/2 bottom-[-50px] sm:bottom-[-60px] -translate-x-1/2 w-[180px] sm:w-[220px] md:w-[260px] lg:w-[300px] border-[5px] sm:border-[6px] border-light rounded-3xl overflow-hidden shadow-2xl bg-light z-20"
            >
              <Image
        ...
        >
          ...
          <p className="text-paragraph text-base md:text-lg leading-relaxed mb-6 w-full lg:max-w-[600px]">
          ...
          <p className="text-paragraph text-base md:text-lg leading-relaxed mb-10 w-full lg:max-w-[580px]">
