  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16 xl:px-24 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-secondary leading-tight mb-10">
            ...
            <SwiperSlide key={index}>
              <div className="bg-primary/20 shadow-sm rounded-2xl p-8 text-left relative flex flex-col justify-between h-full border border-secondary/20 hover:shadow-lg transition-all">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-[#001B48]">{item.name}</h4>
      ...
      <style jsx global>{`
        .custom-pagination .swiper-pagination-bullet {
          width: 10px;
          height: 10px;
          background-color: #b9c8ff; /* light version of primary */
          opacity: 1;
          border-radius: 50%;
          transition: all 0.3s ease;
        }
        .custom-pagination .swiper-pagination-bullet-active {
          background-color: #1A3D91; /* your dark blue secondary */
          transform: scale(1.3);
        }
      `}</style>
    </section>
